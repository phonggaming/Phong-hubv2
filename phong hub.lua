...
local Window = Fluent:CreateWindow({
    Title = phong Hub | Blox Fruits",
    SubTitle = "Made By phong~",
    TabWidth = 160,
...
ImageButton.Image = "http://www.roblox.com/asset/?id=75474257824650"
...
Fluent:Notify({
    Title = "phong Hub",
    Content = "phong hub đang tải🤫.",
    Durtion = 3
})
warn("phong Hub tải xong 🥵!!")
